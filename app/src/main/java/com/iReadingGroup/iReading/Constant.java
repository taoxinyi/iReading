...
public class Constant {
    public static final int POLICY_ONLINE_FIRST =0;
    public static final int POLICY_OFFLINE_FIRST =1;
    public static final int POLICY_MOBILE_OFFLINE_FIRST =2;
    public static final int POLICY_OFFLINE_ALWAYS=3;
